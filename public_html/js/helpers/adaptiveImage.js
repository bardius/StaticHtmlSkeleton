		...
		init : function(w, px) {
			...
			if ( w.addEventListener ) {
				w.addEventListener( "DOMContentLoaded", function(){
					BARDIS.AdaptiveImage.checkAdaptiveElements();
					// Run once only
					w.removeEventListener( "load", BARDIS.AdaptiveImage.checkAdaptiveElements, false );
				}, false );
				w.addEventListener( "load", BARDIS.AdaptiveImage.checkAdaptiveElements, false );
