...
(function (BARDIS, $) {
  ...
  var events = {
    eventListeners: [],
    addListener: function addListener(type, handler, destroyOnUse) {
    ...
    listenerExists: function listenerExists(type, handler) {
      var listener = {};
    ...
    removeListener: function removeListener(type, handler) {
      var listener = {};
...
(function (BARDIS, $, window, document, undefined) {
  ...
  BARDIS.foundationConfig = {
    ...
    setEnhancements: function setEnhancements() {
      ...
      $('.header-sticky-container').on('sticky.zf.unstuckfrom:top', function () {
        var stickyContentHeight = $(this).find('.sticky').first().outerHeight(true);
    ...
    reInitOrbit: function reInitOrbit(orbitElement) {
      var $orbitElement = $(orbitElement);
      var orbitSlider = new Foundation.Orbit($orbitElement);
      orbitSlider.destroy();
  ...
  BARDIS.sampleTest = {
    simpleTest: function simpleTest(projectName) {
...
//# sourceMappingURL=undefined-scripts.min.js.map
