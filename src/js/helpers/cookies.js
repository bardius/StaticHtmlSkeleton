/* ==========================================================================
 ...
 Usage:
 SkeletonApp.cookies.setItem(name, value[, end[, path[, domain[, secure]]]])
 SkeletonApp.cookies.getItem(name)
 SkeletonApp.cookies.removeItem(name[, path])
 SkeletonApp.cookies.hasItem(name)
 SkeletonApp.cookies.keys()
 ========================================================================== */
